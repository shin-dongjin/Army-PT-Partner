...
public class TimerSuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.timer_situp );
        ...
        ImageView imageView = (ImageView) findViewById( R.id.situpImageView );
        imageView.setBackgroundResource( R.drawable.arrow_animation_su );
        ...
        mButtonStart.setOnClickListener( new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(!mTimerRunning){
                    ...
                    Toast.makeText( TimerSuActivity.this, "Timer is already Running!", Toast.LENGTH_SHORT ).show();
                }
            }
        } );
